...
public partial class AppCoreContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Album>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "Unique_Albums").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.AlbumId, e.LanguageId }).HasName("PK_LocalizedAlbums");
            ...
            entity.HasOne(d => d.Album).WithMany(p => p.AlbumLocalizeds)
                .HasForeignKey(d => d.AlbumId)
                .HasConstraintName("FK_LocalizedAlbums_Albums");

            entity.HasOne(d => d.Language).WithMany(p => p.AlbumLocalizeds)
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_AlbumPhotos");
        ...
        modelBuilder.Entity<BannerLocalized>(entity =>
        {
            ...
            entity.HasOne(d => d.Banner).WithMany(p => p.BannerLocalizeds)
                .HasForeignKey(d => d.BannerId)
                .HasConstraintName("FK_BannerLocalized_Banner");

            entity.HasOne(d => d.Language).WithMany(p => p.BannerLocalizeds)
                .HasForeignKey(d => d.LanguageId)
        ...
        modelBuilder.Entity<Career>(entity =>
        {
            ...
            entity.HasOne(d => d.City).WithMany(p => p.Careers)
        ...
        {
            entity.HasKey(e => new { e.CareerId, e.LanguageId }).HasName("PK_JobLocalized");
            ...
            entity.HasOne(d => d.Career).WithMany(p => p.CareerLocalizeds)
                .HasForeignKey(d => d.CareerId)
                .HasConstraintName("FK_JobLocalized_Job");

            entity.HasOne(d => d.Language).WithMany(p => p.CareerLocalizeds)
                .HasForeignKey(d => d.LanguageId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<CityLocalized>(entity =>
        {
            ...
            entity.HasOne(d => d.City).WithMany(p => p.CityLocalizeds)
                .HasForeignKey(d => d.CityId)
                .HasConstraintName("FK_CityLocalized_City");

            entity.HasOne(d => d.Language).WithMany(p => p.CityLocalizeds)
                .HasForeignKey(d => d.LanguageId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_FaqCategories");

            entity.ToTable("FaqCategory");

            entity.HasIndex(e => e.UrlName, "Unique_FaqCategories_Name").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.CategoryId, e.LanguageId }).HasName("PK_LocalizedFaqCategories");
            ...
            entity.HasOne(d => d.Category).WithMany(p => p.FaqCategoryLocalizeds)
                .HasForeignKey(d => d.CategoryId)
                .HasConstraintName("FK_LocalizedFaqCategories_FaqCategories");

            entity.HasOne(d => d.Language).WithMany(p => p.FaqCategoryLocalizeds)
                .HasForeignKey(d => d.LanguageId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.FaqId, e.LanguageId }).HasName("PK_LocalizedFaq");
            ...
            entity.HasOne(d => d.Faq).WithMany(p => p.FaqLocalizeds)
                .HasForeignKey(d => d.FaqId)
                .HasConstraintName("FK_LocalizedFaq_Faqs");

            entity.HasOne(d => d.Language).WithMany(p => p.FaqLocalizeds)
                .HasForeignKey(d => d.LanguageId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<HomeBannerLocalized>(entity =>
        {
            ...
            entity.HasOne(d => d.HomeBanner).WithMany(p => p.HomeBannerLocalizeds)
                .HasForeignKey(d => d.HomeBannerId)
                .HasConstraintName("FK_HomeBannerLocalized_HomeBanner");

            entity.HasOne(d => d.Language).WithMany(p => p.HomeBannerLocalizeds)
                .HasForeignKey(d => d.LanguageId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_InfoPages");

            entity.ToTable("InfoPage");

            entity.HasIndex(e => e.UrlName, "UrlNameUnique_InfoPages").IsUnique();
            ...
            entity.HasOne(d => d.Category).WithMany(p => p.InfoPages)
                .HasForeignKey(d => d.CategoryId)
                .OnDelete(DeleteBehavior.Cascade)
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_InfoPageCategories");

            entity.ToTable("InfoPageCategory");

            entity.HasIndex(e => e.UrlName, "IX_InfoPageCategories_UrlName").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.CategoryId, e.LanguageId }).HasName("PK_LocalizedInfoPageCategories");
            ...
            entity.HasOne(d => d.Category).WithMany(p => p.InfoPageCategoryLocalizeds)
                .HasForeignKey(d => d.CategoryId)
                .HasConstraintName("FK_LocalizedInfoPageCategories_InfoPageCategories");

            entity.HasOne(d => d.Language).WithMany(p => p.InfoPageCategoryLocalizeds)
                .HasForeignKey(d => d.LanguageId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.PageId, e.LanguageId }).HasName("PK_LocalizedInfoPages");
            ...
            entity.HasOne(d => d.Language).WithMany(p => p.InfoPageLocalizeds)
                .HasForeignKey(d => d.LanguageId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_LocalizedInfoPages_Languages");

            entity.HasOne(d => d.Page).WithMany(p => p.InfoPageLocalizeds)
                .HasForeignKey(d => d.PageId)
        ...
        modelBuilder.Entity<MediaCollection>(entity =>
        {
            ...
            entity.HasOne(d => d.Page).WithMany(p => p.MediaCollections)
                .HasForeignKey(d => d.PageId)
        ...
        modelBuilder.Entity<MediaItem>(entity =>
        {
            ...
            entity.HasOne(d => d.Page).WithMany(p => p.MediaItems)
                .HasForeignKey(d => d.PageId)
                .HasConstraintName("FK_MediaItem_SitePages");
        });
        ...
        modelBuilder.Entity<MetaTag>(entity =>
        {
            ...
            entity.Property(e => e.OpenGraphImage).HasMaxLength(80);

            entity.HasOne(d => d.Page).WithMany(p => p.MetaTags)
                .HasForeignKey(d => d.PageId)
        ...
        modelBuilder.Entity<MetaTagLocalized>(entity =>
        {
            ...
            entity.HasOne(d => d.Language).WithMany(p => p.MetaTagLocalizeds)
                .HasForeignKey(d => d.LanguageId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_MetaTagLocalized_Language");

            entity.HasOne(d => d.MetaTag).WithMany(p => p.MetaTagLocalizeds)
        ...
        {
            entity.HasIndex(e => e.UrlName, "Unique_New").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.NewsId, e.LanguageId }).HasName("PK_LocalizedNew");
            ...
            entity.HasOne(d => d.Language).WithMany(p => p.NewsLocalizeds)
                .HasForeignKey(d => d.LanguageId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_LocalizedNew_Languages");

            entity.HasOne(d => d.News).WithMany(p => p.NewsLocalizeds)
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_Subscriber");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_SettingsKeys");
            ...
            entity.HasOne(d => d.Category).WithMany(p => p.Settings)
                .HasForeignKey(d => d.CategoryId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_SettingsCategories");

            entity.ToTable("SettingCategory");

            entity.HasIndex(e => e.Name, "Unique_SettingsCategories").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_BannerType_1");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_SocialLinks");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_Testmonial");
            ...
            entity.HasOne(d => d.TestimonialSource).WithMany(p => p.Testimonials)
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_TestmonialSource");
